...
//	}
	...
	public String updateLike2(int seq) throws Exception {
	...
	// 검색
	@RequestMapping("/reviewSearchboard")
	public ModelAndView searchList2(String item, String search) {

		HashMap<String, String> map = new HashMap();
		map.put("item", item);
		map.put("search", search);

		List<ReviewBoardDTO> searchList = reviewBoardServiceImp.searchList(map);

		ModelAndView mv = new ModelAndView();
		mv.addObject("boardlist2", searchList);
		mv.setViewName("reviewBoard/boardList2");
		return mv;
	}
}